...
from app.data_entry import get_amount, get_category, get_date, get_descriptipn
from config.groq_config import groq_call
...
def main():
    while True:
        ...
        print("3. Talk with your personal agent")
        print("4. Exit")
